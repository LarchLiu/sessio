...
//!
//! The canonical source stays in `docs/create-thread-skill.md`. The Tauri
//! bundle maps that file to `create-thread-skill/SKILL.md` so release builds
//! can point agents at a stable, readable skill path even when the source tree
//! is absent.

use std::path::PathBuf;

const BUNDLED_SKILL_RELATIVE_PATH: &str = "create-thread-skill/SKILL.md";
const DEV_SKILL_RELATIVE_PATH: &str = "docs/create-thread-skill.md";
