...
pub struct SessioPromptMarkers {
    ...
    pub computer_use_prompt_start: &'static str,
    pub computer_use_prompt_end: &'static str,
    ...
    pub computer_use_prompt_kind: &'static str,
...
static SESSIO_PROMPT_MARKERS: SessioPromptMarkers = SessioPromptMarkers {
    ...
    // Legacy marker kept for stripping historical sessions. New skill injection
    // uses `skills_prompt_*`.
    computer_use_prompt_start: "<!-- sessio-computer-use:start",
    computer_use_prompt_end: "<!-- sessio-computer-use:end",
    ...
    computer_use_prompt_kind: "computer_use",
