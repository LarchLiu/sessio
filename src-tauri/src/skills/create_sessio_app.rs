//! Locate the bundled Sessio create-sessio-app skill exposed to agents.

use std::path::PathBuf;

const BUNDLED_SKILL_RELATIVE_PATH: &str = "skills/create-sessio-app/SKILL.md";
const DEV_SKILL_RELATIVE_PATH: &str = "docs/skills/create-sessio-app/SKILL.md";

/// Best-effort absolute path to the create-sessio-app skill.
pub fn create_sessio_app_skill_path() -> Option<PathBuf> {
...
mod tests {
    ...
    fn dev_skill_path_resolves_in_repo() {
        let path = create_sessio_app_skill_path().expect("skill path");
