...
const DICTS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "project.workbench": "Project Kanban",
    "project.type.code": "Code",
    "project.type.writing": "Writing",
    "project.type.research": "Research",
    "project.type.general": "General",
    "project.type.video_production": "Video production",
    "kanban.add": "Add todo",
  ...
  zh: {
    ...
    "project.workbench": "项目看板",
    "project.type.code": "代码",
    "project.type.writing": "写作",
    "project.type.research": "研究",
    "project.type.general": "通用",
    "project.type.video_production": "视频制作",
    "kanban.add": "添加待办事项",
