  ...
  return createPortal(
    <>
      ...
      <div
        ...
        className="fixed z-[60] overflow-hidden rounded-xl border border-ink/10 bg-surface-panel shadow-[0_20px_60px_rgba(0,0,0,0.22)]"
        style={{
          left: pos?.left ?? -9999,
        ...
        role="listbox"
      >
        <ScrollArea className="max-h-[260px] overscroll-contain" viewportClassName="p-1">
          {header && (
