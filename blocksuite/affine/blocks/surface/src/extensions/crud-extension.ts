...
export class EdgelessCRUDExtension extends Extension {
  ...
  addBlock = (
    ...
    // Historical local editor state can leak stale block metadata back into
    // newly inserted edgeless blocks. Always let the store allocate a fresh id
    // and structure for new blocks.
    const { id: _id, flavour: _flavour, children: _children, ...safeProps } =
